...
public class GameObject extends PaintableObject implements GameUpdateListener
{
    ...
    public void paintObject(GraphicsEvent e) {
        ...
        Point p = GameWorld.toScreenSpace((int)(x*GameWorld.BLOCK_PIXEL_DIMENSIONS.width), (int)(y*GameWorld.BLOCK_PIXEL_DIMENSIONS.height), e);

        // if(this instanceof GameEntity){
        //     System.out.println(p + "     |   " + x + "  " + y + "    |   " + getTexture().getWidth() + "     " + getTexture().getHeight());
        // }
