...
public class GameWorld extends PaintableObject implements Serializable
{
    ...
    private static final transient GameProcessLock LOCK = new GameProcessLock();
    private static class GameProcessLock{}
    ...
    public void invokeGameUpdate(long delayNanos){
        if(loadedMap != null){
            loadedMap.gameUpdated(new GameUpdateEvent(loadedMap, System.currentTimeMillis(), 1000/(DESIRED_TICK_SPEED)+(delayNanos/1000000), (int)displayPanel.getMouseX(), (int)displayPanel.getMouseY()));
        }
        for(GameEntity entity : entities){
            entity.gameUpdated(new GameUpdateEvent(loadedMap, System.currentTimeMillis(), 1000/(DESIRED_TICK_SPEED)+(delayNanos/1000000), (int)displayPanel.getMouseX(), (int)displayPanel.getMouseY()));
        }
    }
    ...
    public static GameProcessLock getProcessLock() { return LOCK; }
}
