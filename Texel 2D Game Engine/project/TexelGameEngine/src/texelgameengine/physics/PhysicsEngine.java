...
public class PhysicsEngine 
{
    ...
    public static GameEntity calculateEntityMotion(GameEntity e, GameMap map, float tickSpeed)
    {
        if(e == null) return e;
        ...
        if(map != null && e.hitboxEnabled()){
            ...
            for(GameObject go : collisionBlocks){
                ...
                if(collisionType == GameEntity.NO_COLLISION){
                    ...
                    e.setTime(0);
                    e.setInitial(new InitialPoint(e.getX(), e.getY(), new texelgameengine.physics.Vector(0, 270)));
                    continue;
                }
    ...
    //     GameChunk[] mapProjectiles = mae.getChunksWithinRange(explosive.getX(), explosive.getBlastRadius());
