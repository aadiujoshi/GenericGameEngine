...
//         GameWorld ge = new GameWorld(){
//             @Override
//             public void drawGameFrame(Graphics2D g){
//                 super.drawGameFrame(g);

//                 g.drawString("PLAYER Y: " + player.getY(), 2, 60+15);
//                 g.drawString("PLAYER X: " + player.getX(), 2, 80+15);
//             }
//         };
//         GameWorld.setDebugging(true);
        
//         ge.getFrame().addKeyListener(player);

//         ge.setCamera(player.getCamera());
