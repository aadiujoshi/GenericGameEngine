...
public class FractionalLayout implements java.awt.LayoutManager{
    ...
    public void layoutContainer(Container parent) {
        synchronized(parent.getTreeLock()){
            ...
            for(int i = 0; i < comp.length; i++){
                if(comp[i] instanceof FractionalLayoutValues){
                    FractionalLayoutValues c = (FractionalLayoutValues)comp[i];
