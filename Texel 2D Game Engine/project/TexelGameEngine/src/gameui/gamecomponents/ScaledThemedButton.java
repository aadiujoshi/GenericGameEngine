...
public class ScaledThemedButton extends JButton implements ScaledLayoutValues{
    ...
    public ScaledThemedButton(String text, double widthPositionCoefficient, double heightPositionCoefficient, double widthDimensionCoefficient, double heightDimensionCoefficient){
        super(text);
