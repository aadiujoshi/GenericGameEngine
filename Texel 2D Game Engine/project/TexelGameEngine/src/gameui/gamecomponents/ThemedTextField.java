...
public class ThemedTextField extends JTextArea implements FractionalLayoutValues{
    ...
    public ThemedTextField(double widthPositionCoefficient, double heightPositionCoefficient, double widthDimensionCoefficient, double heightDimensionCoefficient){
